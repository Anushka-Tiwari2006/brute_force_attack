...
if not zipf:       
    ...
    if(result == 0):
        ...
        print("Sorry, password not found. A total of "+str(c)+"+ possible combinations tried in  seconds. Password is not of 4 characters.")
    else:
        duration = endtime - starttime
        starttime = endtime - str('')
        print('Congratulations!!! Password found after trying '+str(c)+' combinations in  seconds')
